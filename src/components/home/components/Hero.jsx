...
const Hero = () => {
    return (
        <div className="my-hero my-14 flex flex-col items-center justify-center px-6">
            <h1 className="text-4xl sm:text-[56px] sm:leading-[68px] font-bold text-center">The Most Free Logo API</h1>
            <div className="text-center my-6">
                <p>Free, unlimited access to brand logos and icons.<br className="hidden sm:block"/> Flexible, fast and always up-to-date.</p>
            </div >
            <div>
